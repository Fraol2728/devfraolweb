  ...
  return (
    <main className="px-4 py-16 sm:px-6">
      <div className="container mx-auto max-w-6xl">
        <motion.header initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="relative overflow-hidden rounded-3xl border border-border bg-linear-to-r from-primary/10 via-card/80 to-card/60 px-6 py-14 text-left md:px-10">
          ...
          <p className="relative mt-4 max-w-2xl text-muted-foreground">Stay updated with our courses and design insights</p>
        </motion.header>
        ...
        <section className="mt-10 grid gap-6 sm:grid-cols-2 xl:grid-cols-3" aria-label="Blog posts">
          ...
          {!loading.list && visiblePosts.length === 0 ? <p className="text-sm text-muted-foreground">No blog posts available right now.</p> : null}
