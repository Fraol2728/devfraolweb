...
export const FixedAuthActions = () => {
  ...
  return (
    ...
    >
      {!user ? (
        <div className="flex items-center gap-2 rounded-2xl border border-white/15 bg-black/45 p-2 backdrop-blur-xl">
          <Link
            to="/login"
            className="rounded-xl border border-white/20 bg-white/5 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:border-[#FF3B30]/70 hover:bg-[#FF3B30]/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF3B30]/70"
          >
            Login
          </Link>
          <Link
            to="/signup"
            className="rounded-xl border border-[#FF3B30]/60 bg-[#FF3B30] px-4 py-2 text-sm font-semibold text-white shadow-[0_0_16px_rgba(255,59,48,0.3)] transition-all duration-300 hover:shadow-[0_0_24px_rgba(255,59,48,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF3B30]/70"
          >
            Signup
          </Link>
        </div>
